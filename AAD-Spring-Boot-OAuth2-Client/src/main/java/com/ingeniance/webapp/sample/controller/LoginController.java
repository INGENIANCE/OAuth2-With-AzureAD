...
public class LoginController {
     ...
     * @param authorizedClient OAuth authorized client from Ingeniance registration
     * @return Azure AD logout URL
     */
    @GetMapping("/aad-logout")
    @ResponseBody
    public ResponseEntity<?> logout(HttpServletRequest request, @RegisteredOAuth2AuthorizedClient("ingeniance") OAuth2AuthorizedClient authorizedClient) {
